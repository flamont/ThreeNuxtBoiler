    ...
    /* Box */
      ...
      let cube = []
          ...
          const cube = new THREE.Mesh(geometry, material)
					...
					cube.position.multiplyScalar( Math.random() * window.innerWidth );
					cube.rotation.set( Math.random() * 2, Math.random() * 2, Math.random() * 2 );
					cube.scale.x = cube.scale.y = cube.scale.z = Math.random() * 30;
					object.add( cube );
...
controls.update();
            ...
            previousTime = elapsedTime
              ...
              // if(cameraPositionY > -500){
              //   camera.position.y = (cameraPositionY -= 10)
              // } else {
              //     camera.position.y = -500 
              // }
              // if(cameraPositionY > -500){
              //   camera.position.y = cameraPositionY / elapsedTime
              // } else {
              //     camera.position.y = -500 
              // }
